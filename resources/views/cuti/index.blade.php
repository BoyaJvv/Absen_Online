...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 py-6 space-y-10">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6">
            ...
            <form method="POST" action="{{ route('cuti.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @csrf
                ...
                <div>
                    ...
                    <select name="nomor_induk"
                        class="w-full rounded-xl border border-gray-300 px-4 py-3 focus:ring focus:ring-blue-200" required>
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" value="{{ date('Y-m-d') }}" min="{{ date('Y-m-d') }}"
                        class="w-full rounded-xl border border-gray-300 px-4 py-3 focus:ring focus:ring-blue-200" required>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#cutiTable').DataTable({
                ...
                dom: "<'d-flex flex-column flex-md-row justify-content-between align-items-center mb-3'Bf>" +
                    "<'table-responsive't>" +
                ...
                buttons: [
                    ...
                    {
                        extend: 'excel',
                        title: 'cuti', // Nama file Excel
                        filename: 'cuti' // Nama file saat di-download
                    },
                    {
                        extend: 'pdf',
                        title: 'cuti', // Judul di PDF
                        filename: 'cuti' // Nama file PDF
                    },
                    'print',
                    {
                        extend: 'colvis',
