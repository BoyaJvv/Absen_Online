    ...
    <aside class="w-64 text-white flex flex-col bootslander-sidebar">
        ...
        <nav class="flex-1 px-3 py-4 text-sm space-y-1">
            ...
            <details class="group mt-1">
                <summary class="flex items-center justify-between px-4 py-2 rounded cursor-pointer hover:bg-white/10">
        ...
        <div class="p-4 border-t border-white/10">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button class="w-full bg-red-600 hover:bg-red-700 py-2 rounded flex items-center justify-center gap-2">
