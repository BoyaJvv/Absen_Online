...
@section('content')
    <div class="container">
        ...
        @if (in_array(auth()->user()->jabatan_status, [0, 1]))
            <form method="GET" class="mb-4">
                <select name="cabangGedung" class="form-select w-25" onchange="this.form.submit()">
    ...
    <script>
        ...
        console.log('Tepat:', tepatWaktu);
        console.log('Telat:', terlambat);
