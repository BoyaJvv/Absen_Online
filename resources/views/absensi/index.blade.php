            ...
            <form method="GET" action="{{ route('absensi.index') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="awal" class="w-full h-12 rounded-xl border border-gray-300 text-base"
                            value="{{ request('awal') }}" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="akhir" class="w-full h-12 rounded-xl border border-gray-300 text-base"
                            value="{{ request('akhir') }}" required>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="kategori" class="w-full h-12 rounded-xl border border-gray-300 text-base">
                            ...
                            <option value="3" {{ request('kategori') == 3 ? 'selected' : '' }}>Istirahat Selesai
                            </option>
